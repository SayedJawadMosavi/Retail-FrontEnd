<template>
  <VDialog
    ...
    persistent
  >
    <VCard v-if="editType == 'expense'" title="د اضافي مصرف ایدیت">
      <VCardText>
          ...
          <VRow>
            ...
            <VCol cols="12">
              <VTextField
                ...
                :rules="validationRules($v2.name, 'د محصول نوم')"
              />
            </VCol>
            ...
            <!-- 👉 Create Key Button -->
            <VCol cols="12">
              <VBtn :loading="apiLoading2" @click="validateExpenseForm"> ذخیره </VBtn>
    ...
    <VCard v-if="editType == 'item'" title="د محصول ایدیت">
      <VCardText>
        <!-- 👉 Form -->
