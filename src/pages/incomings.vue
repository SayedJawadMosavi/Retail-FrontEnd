  ...
  <div>
    ...
    >
      <template #default>
        ...
        <VBtn class="font-weight-bold bg-info" to="expense_income_category">
          کټګوری
    ...
    >
      ...
      <template #paid_amount="{ item }">
        <VChip small color="success" class="font-weight-medium">
          {{ item?.payments_sum_amount ?? 0 }}
        </VChip>
      </template>
      <template #total_amount="{ item }">
        <VChip small color="primary" class="font-weight-medium">
